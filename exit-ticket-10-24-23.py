...
# Challenge question!
3. We can *invert* a color by subtracting its respective (B, G, R) values from 255. For example, 
the inverse of green (0, 255, 0) is purple (255, 0, 255). The inverse of gray (127, 127, 127) 
is also gray (128, 128, 128). 

In the following code block, complete the function `invert_color` 
which takes in a tuple representing a BGR color, and returns a tuple representing its inverse.
"""
